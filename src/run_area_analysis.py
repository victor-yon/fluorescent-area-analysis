from area_analysis import save_all_area_scans, area_processing, area_batch_processing
...
if __name__ == '__main__':
    ...
    example_data = open_image('tests/examples/crusI-left/Default', 2, rolling_ball_radius)

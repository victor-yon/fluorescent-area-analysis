...
from particles_analysis import save_all_particle_scans, particles_processing, particles_batch_processing
...
if __name__ == '__main__':
    ...
    example_data = open_image('data/L_CrusI_20x_center_left/Default', 1, rolling_ball_radius)
